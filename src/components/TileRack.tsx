...
export function TileRack({ tiles, selectedTile, selectedForExchange, exchangeMode, onTileSelect, onFlipTile }: TileRackProps) {
  return (
    <div className="bg-slate-800/80 backdrop-blur rounded-xl p-4 border border-slate-700">
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs text-slate-400 uppercase tracking-wider">Your Tiles</span>
        {exchangeMode && (
